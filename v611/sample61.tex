...
\title{Anzdf Example Article using \aastex v6.1\footnote{This version fixes many bugs from v6.0 and introduces some new features, primarily in the way the author and affiliations are now marked up.}}
